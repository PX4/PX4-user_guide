...
- [Типи літальних апаратів і налаштування](airframes/index.md)
  ...
  - [Rovers (experimental)](frames_rover/index.md)
    - [Режими польоту](flight_modes_rover/index.md)
...
- [Вибір обладнання & Налаштування](hardware/drone_parts.md)
  ...
  - [Flight Controllers (Autopilots)](flight_controller/index.md)
    ...
    - [Зняті з виробництва автопілоти/транспортні засоби](flight_controller/autopilot_discontinued.md)
      ...
      - [Holybro Kakute F7 (Знято з виробництва)](flight_controller/kakutef7.md)
      ...
      - [Intel®️ Aero RTF Drone (припинено)](complete_vehicles_mc/intel_aero.md)
  ...
  - [Сенсори](sensor/index.md)
    ...
    - [Датчики відстані \(далекодобива\)](sensor/rangefinders.md)
      ...
      - [Інтерфейс анонімного лазерного висотоміра UAVCAN авіоніки](dronecan/avanon_laser_interface.md)
  ...
  - [Комп’ютери-супутники](companion_computer/index.md)
    - [Налаштування Pixhawk + Companion](companion_computer/pixhawk_companion.md)
      - [RasPi Pixhawk Компаньйон](companion_computer/pixhawk_rpi.md)
    ...
    - [Комп'ютерний зір](computer_vision/index.md)
      - [Уникнення перешкод](computer_vision/obstacle_avoidance.md)
      - [Безпечна посадка](computer_vision/safe_landing.md)
      ...
      - [Візуальна інерційна одометрія (VIO)](computer_vision/visual_inertial_odometry.md)
        - [Камера стеження Realsense T265 (VIO)](camera/camera_intel_realsense_t265_vio.md)
...
- [Розробка](development/development.md)
  ...
  - [Налаштування розробника що підтримуються спільнотою](advanced/community_supported_dev_env.md)
    ...
    - [Симулятори](simulation/community_supported_simulators.md)
      ...
      - [Симуляція JSBSim](sim_jsbsim/index.md)
      - [Імітування AirSim](sim_airsim/index.md)
      - [Симуляція HITL](simulation/hitl.md)
      - [Симуляція у залізі](sim_sih/index.md)
...
- [Релізи](releases/index.md)
  ...
  - [1.15 (beta)](releases/1.15.md)
  - [1.14 (stable)](releases/1.14.md)

...
| Indoor (non-flat terrain) | 0 (вимкнено)                                                               | 1 (увімкнено)                                                                | 1 ([умовно](#conditional-range-aiding))                                    | 2 (range)                                                                |
| Indoor (flat terrain)     | 0 (disabled)                                                               | 1 (увімкнено)                                                                | 2 ([завжди увімкнено](#range-height-fusion))                               | 2 (діапазон)                                                             |
| External vision           | As required                                                                | As required                                                                  | As required                                                                | 3 (бачення)                                                              |

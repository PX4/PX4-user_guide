...
PX4 включає репозиторій [mavlink/mavlink](https://github.com/mavlink/mavlink) як підмодуль у [/src/modules/mavlink](https://github.com/PX4/PX4-Autopilot/tree/release/1.15/src/modules/mavlink). Тут містяться файли визначень XML у каталозі [/mavlink/messages/1.0/](https://github.com/mavlink/mavlink/blob/master/message_definitions/v1.0/).
...
Спочатку створіть файл з назвою `BATTERY_STATUS_DEMO.hpp` для вашого класу потокового передавання (названого за повідомленням, яке потрібно передавати) у директорії [/src/modules/mavlink/streams](https://github.com/PX4/PX4-Autopilot/tree/release/1.15/src/modules/mavlink/streams).
...
Більшість потокових класів дуже схожі (див. приклади у [/src/modules/mavlink/streams](https://github.com/PX4/PX4-Autopilot/tree/release/1.15/src/modules/mavlink/streams)):

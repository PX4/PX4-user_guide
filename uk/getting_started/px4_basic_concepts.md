...
"Мізками" дрону є автопілот. Він складається з програмного забезпечення _політного стека_ яке виконується на _контролері апарата_ ("політному контролері"). Політний стек забезпечує основну стабілізацію та функції безпеки, а зазвичай також певний рівень допомоги пілоту для ручного польоту та автоматизації загальних завдань, таких як зліт, посадка та виконання попередньо визначених місій.
...
- Чудовий вибір апаратного забезпечення для [політного контролера](#flight-controller-board), сенсорів та інших периферійних пристроїв.

---
canonicalUrl: https://docs.px4.io/main/tr/middleware/uorb
---
...
The full API is documented in [platforms/common/uORB/uORBManager.hpp](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/platforms/common/uORB/uORBManager.hpp).

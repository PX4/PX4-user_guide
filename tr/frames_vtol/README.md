...
In addition, build logs showing how others have set up different types of vehicles provided as sub topics. For exmaple see [FunCub QuadPlane](../frames_vtol/vtol_quadplane_fun_cub_vtol_pixhawk.md).

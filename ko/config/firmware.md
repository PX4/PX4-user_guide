...
:::warning
**Before you start installing Firmware** all USB connections to the vehicle must be *disconnected* (both direct or through a telemetry radio). 기체에 배터리 전원 연결을 *중지*하여야 합니다.
:::

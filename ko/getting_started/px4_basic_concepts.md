...
[무선 조종기\(RC\)](../getting_started/rc_transmitter_receiver.md)시스템은 기체를 *수동으로* 조종할 때 사용합니다. 고정/제어 위치에서 통신하는 송신기가 붙은 무선 조종기와 기체에 붙어있는 수신기로 이루어져있습니다. 일부 무선 조종 시스템은 오토파일럿이 송신하는 무선 측정 정보를 되받기도 합니다.

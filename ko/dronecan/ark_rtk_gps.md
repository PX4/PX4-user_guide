...
- Open u-center, select the COM port for the ARK RTK GPS and connect ![U-Center Connect](../../assets/hardware/gps/ark/ark_rtk_gps_ucenter_connect.png)
...
- To update the firmware:
  ...
  - "Firmware Update SUCCESS" should be displayed if it updated successfully ![펌웨어 업데이트](../../assets/hardware/gps/ark/ark_rtk_gps_ublox_f9p_firmware_update.png)

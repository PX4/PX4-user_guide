...
_Pixhawk 4_ can be triple-redundant on the power supply if three power sources are supplied. 이 세개의 파워 레일은: **POWER1**, **POWER2** 그리고 **USB** 입니다.
...
[PX4 시스템 콘솔](../debug/system_console.md)과 [SWD 인터페이스](../debug/swd_debug.md)는 **FMU 디버그** 포트에서 실행되며 I/O 콘솔 및 SWD 인터페이스는 ** I/O 디버그** 포트를 통하여 액세스할 수 있습니다.. In order to access these ports, the user must remove the _Pixhawk 4_ casing.

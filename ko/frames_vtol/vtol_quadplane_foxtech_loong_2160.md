...
- [3D-Printed mounts](https://github.com/PX4/PX4-user_guide/raw/v1.15/assets/airframes/vtol/foxtech_loong_2160/loong-3d-prints.zip)
  - 1x Baseplate
  - 1x Stack-fixture
  - 1x Fan-Mount
  - 1x Radio-Mount
...
Next we load a [parameter file](https://github.com/PX4/PX4-user_guide/raw/v1.15/assets/airframes/vtol/foxtech_loong_2160/loong.params) that contains parameters that define the frame geometry, output mappings, and tuning values — so you don't have to!
...
1. Download the [parameter file](https://github.com/PX4/PX4-user_guide/raw/v1.15/assets/airframes/vtol/foxtech_loong_2160/loong.params).

...
:::note
`TELEM2` 포트는 [MAV_2_CONFIG](../advanced_config/parameter_reference.md#MAV_2_CONFIG) 매개변수를 사용하여 두 번째 MAVLink로 구성하여야 합니다. 자세한 내용은 [MAVLink 주변 장치 &gt; MAVLink 인스턴스](../peripherals/mavlink_peripherals.md#mavlink-instances)(및 [직렬 포트 구성](../peripherals/serial_configuration.md))를 참조하십시오.
:::
---
canonicalUrl: https://docs.px4.io/main/ko/msg_docs/telemetry_status
---

# telemetry_status (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/telemetry_status.msg)

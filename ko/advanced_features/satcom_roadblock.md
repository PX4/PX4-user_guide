...
* The [RockBlock MK2](https://www.rock7.com/products/rockblock-iridium-9602-satellite-modem) module can also be used. RockBlock 9603 모듈은 크기가 작고 가볍우면서도 동일한 기능을 제공하기 때문에 권장됩니다.
:::

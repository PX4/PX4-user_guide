...
위성통신 시스템은 기체외 지상국간의 광역 통신을 제공합니다.

이리듐 SBD 위성 통신 시스템의 서비스 공급자 RockBlock을 사용하여 시스템을 설정하는 방법을 설명합니다. 신호 품질이 우수한 경우에도 10~15초 정도의 시간 지연이 있을 수 있습니다.

## 개요

위성 통신에는 다음의 요소들이 필요합니다.

* PX4의 Pixhawk에 연결되면 깜빡이는 [RockBlock 9603](http://www.rock7mobile.com/products-rockblock-9603) 모듈

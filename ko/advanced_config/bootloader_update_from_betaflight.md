...
### Betaflight Configurator로 부트로더 업데이트하기 {#betaflight_configurator}

*Betaflight Configurator*를 이용하여 PX4 부트로더 설치하려면:
...
두 방법 모두 보드가 DFU 모드에 있어야합니다. DFU 모드로 들어가려면 USB 케이블을 컴퓨터에 연결 한 상태에서 부팅 버튼을 누르십시오. 보드의 전원이 켜지면 버튼을 놓아도 됩니다.
...
비행 컨트롤러를 재부팅하면 부팅 버튼을 누르지 않고도 부팅 할 수 있습니다.
...
## Betaflight 재설치 {#reinstall_betaflight}

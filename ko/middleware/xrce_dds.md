...
:::note
At time of writing there is no PX4 parameter for setting the address of the remote host on which the XRCE-DDS agent is running. Therefore for Ethernet connections you will _have_ to use a command to start the client.
:::

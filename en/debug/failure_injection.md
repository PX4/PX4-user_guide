---
canonicalUrl: https://docs.px4.io/main/en/debug/failure_injection
---
...
It is used in [PX4 Integration Testing](../test_and_ci/integration_testing_mavsdk.md) to simulate failure cases (for example, see [PX4-Autopilot/test/mavsdk_tests/autopilot_tester.cpp](https://github.com/PX4/PX4-Autopilot/blob/release/1.14/test/mavsdk_tests/autopilot_tester.cpp)).

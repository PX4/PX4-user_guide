...
In **Copter / Multicopter** mode the VTOL is controlled exactly like a [Copter/Multicopter](https://github.com/PX4/px4_user_guide/blob/master/en/getting_started/basic_flight_modes.md#copter-flight-modes)

In **Forward Flight - Fixed Wing** mode the VTOL is controlled exectly like an [Airplane - Fixed Wing Aircraft](https://github.com/PX4/px4_user_guide/blob/master/en/getting_started/basic_flight_modes.md#fixed-wing-aircraft-modes)

...
:::note
As long as the world file and the model file are in the Gazebo search path `GZ_GAZEBO_RESOURCE_PATH` it is not necessary to add them to the PX4 world and model directories.

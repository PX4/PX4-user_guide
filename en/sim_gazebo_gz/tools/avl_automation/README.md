...
The idea of this tool is to automate the writing of the Advanced Lift Drag plugin used by the Advanced Plane by automatizing the coefficient generation and requiring minimal user calculations.

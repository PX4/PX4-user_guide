...
All models are automatically fetched from the [Gazebo Models Repository](../sim_gazebo_gz/gazebo-models.md) repository on first run, and placed in the `~/.simulation-gazebo` repository.

...
- The ground station computer typically runs [QGroundControl](../getting_started/px4_basic_concepts.md#ground-control-stations-qgroundcontrol) (or some other ground station software).

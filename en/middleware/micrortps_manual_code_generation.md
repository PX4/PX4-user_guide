---
canonicalUrl: https://docs.px4.io/main/en/middleware/micrortps_manual_code_generation
---
...
The manually generated *Agent* code is also compiled and used in the same way as the [automatically generated code](../middleware/micrortps.md#agent-in-an-offboard-fast-dds-interface-ros-independent).

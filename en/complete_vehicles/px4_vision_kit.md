...
:::warning
For PX4 Vision with ECN below 010 (carrier board RC04 and below), the *UP Core* should only be powered using the battery (do not remove the *UP Core power* socket safety cover).

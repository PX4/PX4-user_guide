...
1. For PX4 Vision with ECN below 010 (carrier board RC04 and below), the *UP Core* should **only** be powered using the battery (do not remove the *UP Core* power socket safety cover).

   ![ECN Number](../../assets/hardware/px4_vision_devkit/Serial_Number_Update.jpg)
...
1. PX4 Vision with ECN 010 or above (carrier board RC05 and up), the *UP Core* can be powered by either the DC plug or with battery.
  ...
  ![RC Number](../../assets/hardware/px4_vision_devkit/RC.png)

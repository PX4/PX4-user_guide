...
<tr>
 ...
 <td>Heading/Yaw offset for dual antenna GPS <p><strong>Comment:</strong> Heading offset angle for dual antenna GPS setups that support heading estimation. Set this to 0 if the antennas are parallel to the forward-facing direction of the vehicle and the Rover antenna is in front. The offset angle increases clockwise. Set this to 90 if the Rover antenna is placed on the right side and the Moving Base on the left side of the vehicle.</p>   <p><b>Reboot required:</b> true</p>
</td>
 <td>0 > 360 </td>
 <td>0.</td>
 <td>deg</td>

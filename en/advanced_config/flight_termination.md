---
canonicalUrl: https://docs.px4.io/main/en/advanced_config/flight_termination
---
...
- [Safety > Failure Detector > Attitude Trigger](../config/safety.md#attitude-trigger) explains how to configure the attitude limits that trigger *Flight termination*.
  :::note

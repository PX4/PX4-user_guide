...
:::note
Newer versions of the betaflight configurator do not allow non-betaflight bootloader update.
If you have issue with installing bootloader with betaflight configurator, please use other methods. 
:::

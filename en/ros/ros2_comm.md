...
While microRTPS client is the same, the IDL files used by ROS 2 are slightly different from the custom ones with generate in PX4. /* something is weird in this sentence */

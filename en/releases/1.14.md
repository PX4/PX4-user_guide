---
canonicalUrl: https://docs.px4.io/main/en/releases/1.14
---
...
- [DroneCAN sensors now need to be individually enabled via `UAVCAN_SUB_*` parameters](../dronecan/README.md#dronecan-subscriptions-publications) - [PX4-Autopilot#18471](https://github.com/PX4/PX4-Autopilot/pull/18471)
...
- [SIH] Standalone sensor simulations in tree: Ability to simulate sensors in tree that was part of SIH is now a stand alone sensor module. Sensors include magnetometer, GPS, Barometer, Airspeed - [PX4-Autopilot#20137](https://github.com/PX4/PX4-Autopilot/pull/20137), https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/modules/simulation/sensor_airspeed_sim

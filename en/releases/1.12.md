...
* **Support for querying `COMPONENT_INFORMATION` ([PR#16039](https://github.com/PX4/PX4-Autopilot/pull/16039))**
  * This new message allows a GCS to request rich hierarchical information from an autopilot; i.e. in order to understand which commands are supported in missions, or to get parameter metadata (RFC: [mavlink#1339](https://github.com/mavlink/mavlink/issues/1339))

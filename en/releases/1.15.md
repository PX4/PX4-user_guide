...
- Add parameter to disable time synchronization between Agent and Client. [PX4-Autopilot#21757](https://github.com/PX4/PX4-Autopilot/pull/21757)
  ...
  Documentation: [Middleware uXRCE-DDS](../middleware/uxrce_dds.md#starting-the-client) / [ROS 2](../ros2/user_guide.md#ros-gazebo-and-px4-time-synchronization) / [Gazebo Simulation](h../sim_gazebo_gz/index.md#px4-gazebo-time-synchronization)

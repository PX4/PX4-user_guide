...
<span></span>
> **Note** The [FlightGear](../simulation/flightgear.md) page shows how to install and use FlightGear in more detail.
...
> **Note** This variant needs the latest FlightGear code (sources at least from 26 April 2020).

...
- [Gazebo](sim_gazebo_gz/gazebo.md) is the successor of [Gazebo Classic](sim_gazebo_classic/gazebo.md). Like its precursor, it supports multiple vehicles simultaneously but, at the time of writing, only one frame (X500 quadcopter) is implemented in PX4.

...
- `-b`: Baud rate (optional) if the driver supports multiple baud rates.
  ...
  :::tip
  See the [gps driver](https://github.com/PX4/PX4-Autopilot/blob/release/1.15/src/drivers/gps/gps.cpp#L1023) for an example.
  :::
...
1. Create a YAML module configuration file:
   ...
   - Insert the following text and adjust as needed:
     ...
     ::: info
     The full documentation of the module configuration file can be found in the [validation/module_schema.yaml](https://github.com/PX4/PX4-Autopilot/blob/release/1.15/validation/module_schema.yaml) file.

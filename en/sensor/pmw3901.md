...
- For UART version PMW3901 like ThoneFlow-3901UY, needs to set [SENS_TFLOW_CFG](../advanced_config/parameter_reference.md#SENS_TFLOW_CFG) to the value of the UART port you connected. For example, if you connected this sensor to `TELEM 2`, you need to set [SENS_TFLOW_CFG](../advanced_config/parameter_reference.md#SENS_TFLOW_CFG) to `102`.

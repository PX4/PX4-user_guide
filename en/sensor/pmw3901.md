...
- DroneCAN sensors you must set `UAVCAN_ENABLE` appropriately.
  For more information see [DroneCAN Peripherals](../dronecan/README.md) (and the [HereFlow PMW3901 docs below](#dronecan_wiring)).
...
The [Holybro PMW3901 Optical Flow Sensor](https://holybro.com/products/pmw3901-optical-flow-sensor) exposes a PMW3901 optical flow module via a UART interface. It comes with a 3D printed case and has a pre-soldered TX, Voltage, and GND 4 pin connector that can be plug into the telemetry port of your Flight Controller as followed.

<img src="../../assets/hardware/sensors/pmw3901/holybro-pmw3901-3.jpg" width="450px" title="HB-pmw3901-3" />

...
PX4 supports the [UAVCAN](../uavcan/README.md) bus for connecting peripherals, including ESCs, GPS modules, various types of sensors, etc.
...
:::tip
We recommend automated [ESC Enumeration using QGroundControl](#esc-enumeration-using-qgroundcontrol) shown above rather than manual enumeration (as it is easier and safer).
:::

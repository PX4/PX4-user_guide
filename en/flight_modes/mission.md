...
Missions can be paused by switching out of mission mode into to any other mode (such as [Hold mode](../flight_modes/hold.md) or [Position mode](../flight_modes/position_mc.md).

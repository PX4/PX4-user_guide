# Windows Development Environment Maintenances

This topic explains how to construct and extend the development environment used for the supported [Windows Deveopment Environment.](../dev_setup/dev_env_windows_cygwin.md)

...
With *VScode*, configuration is stored in the PX4/PX4-Autopilot tree ([PX4-Autopilot/.vscode](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/.vscode)) so the setup process is as simple as adding the project folder.
:::

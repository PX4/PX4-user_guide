---
canonicalUrl: https://docs.px4.io/main/en/flying/pre_flight_checks
---
...
* Excessive in this case means that the bias estimate exceeds half the configured limit.
  The limit is defined in the [EKF2_ABL_LIM](../advanced_config/parameter_reference.md#EKF2_ABL_LIM) parameter.

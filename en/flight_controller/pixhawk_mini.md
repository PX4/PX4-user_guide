...
Pixhawk (designed by 3DR in collaboration with HobbyKing<sup>&reg;</sup>). 
...
- Improved sensors, both primary and secondary IMU MPU9250 and
  ICM20608 respectively. Expect better vibration handling and reliability.
...
ground control station running on a phone). 
...
provide power on the other outputs. 

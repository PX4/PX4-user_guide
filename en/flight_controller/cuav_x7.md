---
canonicalUrl: https://docs.px4.io/main/en/flight_controller/cuav_x7
---
...
:::tip
The manufacturer [CUAV Docs](https://doc.cuav.net/x7/en/x7.html) are the canonical reference for the X7.

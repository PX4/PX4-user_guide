...
- **FMUv5:** New processor (F7). Much faster. More RAM. More CAN busses. Much more configurable.([Pixhawk 4](../flight_controller/pixhawk4.md),[Pixhack v5](../flight_controller/pixhack_v5.md),[V5+](../flight_controller/v5+.md),[V5 nano](../flight_controller/v5_nano.md))

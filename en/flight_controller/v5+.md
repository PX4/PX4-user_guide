...
The board is based on the Pixhawk **FMUv5 design standard**, the external interface uses the [Pixhawk standard pinouts](https://pixhawk.org/pixhawk-connector-standard/), and the modular design allows the users to customize their own carrier board. The autopilot is compatible with both [PX4](http://px4-travis.s3.amazonaws.com/Firmware/master/px4fmu-v5_default.px4) and [ArduPilot](http://firmware.ardupilot.org) firmware.can be used for academic research and commercial systems integration.

![V5+ AutoPilot](../assets/flight-controller/v5+/v5+_01.png)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_02.jpg)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_03.jpg)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_04.jpg)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_06.jpg)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_07.jpg)
![V5+ AutoPilot](../assets/flight-controller/v5+/en/v5+_08.jpg)
...
![V5+ AutoPilot](../assets/flight-controller/v5+/v5+_pinouts.png)

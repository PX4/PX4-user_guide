...
<img src="../../assets/flight_controller/pixhawk6x_pro/pixhawk6x_pro_internal_architecture.jpeg" width="800px" title="Pixhawk6X Pro Internal Architecture" />
...
_Pixhawk 6X Pro_ can be triple-redundant on the power supply if three power sources are supplied. The three power rails are: **POWER1**, **POWER2** and **USB**.
...
Digital I2C battery monitoring is enabled by default (see [Quickstart > Power](../assembly/quick_start_pixhawk6x_pro.md#power)).

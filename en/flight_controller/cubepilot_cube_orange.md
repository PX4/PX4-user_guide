...
:::tip
The PX4 dev team supports this flight controller as a footprint compatible replacement for Cube Black. We recommend however to consider products build on industry standards, such as the [Pixhawk Standards](https://pixhawk.org). This flight controller is not following the standard and uses a patented connector.
:::

...
The [Pixhawk<sup>&reg;</sup> 1](https://pixhawk.org/modules/pixhawk) autopilot is a popular general purpose flight controller based on the [Pixhawk-project](https://pixhawk.org/) **FMUv2** open hardware design. It runs PX4 on the [NuttX](http://nuttx.org) OS.

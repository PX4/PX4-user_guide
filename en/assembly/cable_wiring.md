...
This protocol is commonly use is for connecting [optical flow](../../en/sensor/optical_flow.md) sensors or special telemetry modems.
...
[GPS receivers and magnetometers](en/gps_compass/README.md) are generally very sensitive to EMI.

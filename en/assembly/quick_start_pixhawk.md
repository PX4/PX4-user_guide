...
> **Note** The [3DR Pixhawk](../flight_controller/pixhawk.md) is no longer available from 3DR.
...
The *Pixhawk* should be mounted on the frame using vibration-damping foam pads (included in the kit).

...
For VESC the preferred tool for motor enumeration is the [VESC tool](https://vesc-project.com/vesc_tool). Besides the normal motor configuration that you will have to setup in the VESC tool, it is also required to properly setup the app configuration. The recommended app setup is as follows:

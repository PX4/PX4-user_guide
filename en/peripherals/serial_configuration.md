---
canonicalUrl: https://docs.px4.io/main/en/peripherals/serial_configuration
---
...
You can include the missing driver in firmware by enabling the driver in the **default.px4board** config file that corresponds to the [board](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/boards/px4) you want to build for.

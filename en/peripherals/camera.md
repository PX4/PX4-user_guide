...
If using a mixer on a flight controller with both FMU and IO board, pin 1 goes to `AUX 5`, and Pin 2 to `AUX 6` (if using control allocation the pins can be assigned to any FMU output).

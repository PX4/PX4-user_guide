---
canonicalUrl: https://docs.px4.io/main/en/peripherals/parachute
---
...
:::note
In fact PX4 does not know that it is launching a parachute; during flight termination it just turns off all controllers and sets all PWM outputs to their failsafe values.

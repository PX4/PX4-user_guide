...
It is commonly used to navigate a vehicle in situations where GPS is absent (e.g. indoors), and provides position relative to a *local* coordinate system.
...
- [Flying with Motion Capture (VICON, Optitrack, Nokov)](../tutorials/motion-capture.md).  <!-- bring across info into user guide? -->

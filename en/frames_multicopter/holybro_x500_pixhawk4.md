...
_Figure 8_: Flight controller/Power module PWM and Power connections
...
**Step 8:** Feed the PM07 cables through the top plate.
...
**Step 9:**
Push the arm tubes a bit into the frame and make sure the amount of protrusion (red square from Figure 11) are consistent on all 4 arms.
...
**Step 10:**
Put the hanger gaskets into the 4 hangers (Figure 11) and mount them onto the bottom plate using 8 hex screws.
...
**Step 11:**
Insert the slide bars onto the hanger rings (Figure 13).
...
For general information on tuning see: [Multicopter Basic PID Tuning](../config_mc/pid_tuning_guide_multicopter_basic.md).

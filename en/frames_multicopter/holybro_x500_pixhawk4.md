---
canonicalUrl: https://docs.px4.io/main/en/frames_multicopter/holybro_x500_pixhawk4
---
...
1. Mount the telemetry radio onto the top plate.
   ...
   Plug the cable from PM07 `FMU-PWM-in` to `I/O-PWM-out`on the FC and PM07 `PWR1` to `POWER1` on the FC.
   
Refer to [Pixhawk 4 Quick Start](../assembly/quick_start_pixhawk4.md) for more information.

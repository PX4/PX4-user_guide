# Holybro X500 V2 + Pixhawk5x Build

This topic provides full instructions for building the kit and configuring PX4 using *QGroundControl*.

## Key information

- **Full Kit:** [Holybro X500 V2 Kit](http://shop.holybro.com/x500-v2-kit_p1288.html)
- **Frame:** [Holybro X500](http://shop.holybro.com/x500-v2-kit_p1288.html)
- **Flight controller:** [Pixhawk 5x](../flight_controller/pixhawk5x.md)
- **Assembly time (approx.):** 1.5 hours (60 minutes for frame, 30 minutes for autopilot installation/configuration)
...
For instructions on how, see: [Multicopter Basic PID Tuning](../config_mc/pid_tuning_guide_multicopter_basic.md).

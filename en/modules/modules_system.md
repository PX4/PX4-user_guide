...
## internal_combustion_engine_control
Source: [modules/internal](https://github.com/PX4/PX4-Autopilot/tree/main/src/modules/internal_combustion_engine_control)

**NOTE:** This feature is not enabled by default and needs to be configured with the rpm capture driver.
...
The module publishes `InternalCombustionEngineControl.msg` containing:
...
- allows for user inputs from
  - AUX{N}
  - the arming state in `VehicleStatus.msg`
  - Mavlink (TBD)
...
### Usage
```
internal_combustion_engine_control_usage <command> [arguments...]
 Commands:
   start         Start the background task

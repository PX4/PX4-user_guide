---
canonicalUrl: https://docs.px4.io/main/en/modules/module_template
---
...
[src/examples/work_item](https://github.com/PX4/PX4-Autopilot/tree/release/1.13/src/examples/work_item).
...
1. Specify the queue to add the task to in the constructor initialisation.
   The [work_item](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/src/examples/work_item/WorkItemExample.cpp#L42) example adds itself to the `wq_configurations::test1` work queue as shown below:
   ```cpp
...
[src/templates/template_module](https://github.com/PX4/PX4-Autopilot/tree/release/1.13/src/templates/template_module).

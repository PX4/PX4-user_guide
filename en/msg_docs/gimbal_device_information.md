---
canonicalUrl: https://docs.px4.io/main/en/msg_docs/gimbal_device_information
---

# gimbal_device_information (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/gimbal_device_information.msg)

---
canonicalUrl: https://docs.px4.io/main/en/msg_docs/sensor_gnss_relative
---

# sensor_gnss_relative (UORB message)
...
[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/sensor_gnss_relative.msg)

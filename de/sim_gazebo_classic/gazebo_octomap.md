---
canonicalUrl: https://docs.px4.io/main/de/sim_gazebo_classic/gazebo_octomap
---
...
Run the following three lines in *separate* terminal windows. This opens up [Gazebo Classic](../sim_gazebo_classic/README.md), *Rviz* and an octomap server.

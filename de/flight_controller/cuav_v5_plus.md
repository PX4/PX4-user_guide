---
canonicalUrl: https://docs.px4.io/main/de/flight_controller/cuav_v5_plus
---
...
The *V5+* has over current protection on the 5 Volt Peripheral and 5 Volt high power, which limits the current to 2.5A. The *V5+* has short circuit protection. The *V5+* has short circuit protection.

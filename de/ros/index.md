...
Note that ROS 2 can be installed on Ubuntu Linux, macOS, Windows, while ROS 1 is only available on Linux. This option is supported by the MAVROS project. Although it might work on the other platforms, PX4 primarily tests and documents ROS on _Linux_. :::note ROS 2 can also connect with PX4 using [MAVROS](https://github.com/mavlink/mavros/tree/ros2/mavros) (instead of XRCE-DDS).

...
1. Make sure the receiver is powered with at least 3.3V. Make sure the receiver is powered with at least 3.3V. You can use the micro USB connector or the 6-pin connector. You can use the USB Micro-B connector or the 6-pin JST connector.

---
canonicalUrl: https://docs.px4.io/main/de/msg_docs/npfg_status
---

# npfg_status (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/npfg_status.msg)

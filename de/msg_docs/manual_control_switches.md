---
canonicalUrl: https://docs.px4.io/main/de/msg_docs/manual_control_switches
---

# manual_control_switches (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/manual_control_switches.msg)

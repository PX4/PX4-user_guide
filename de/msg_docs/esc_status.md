---
canonicalUrl: https://docs.px4.io/main/de/msg_docs/esc_status
---

# esc_status (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/esc_status.msg)

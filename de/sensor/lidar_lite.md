---
canonicalUrl: https://docs.px4.io/main/de/sensor/lidar_lite
---
...
The *Lidar-Lite v3* can be used with either PWM or I2C. PWM is recommended if using an older model. PWM is recommended if using an older model. The rangefinder must be separately powered via some ESC/BEC (whether connected via PWM or I2C).

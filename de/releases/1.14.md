---
canonicalUrl: https://docs.px4.io/main/de/releases/1.14
---
...
- If multiple failsafes are triggered, the more severe _action_ is taken. For example if both RC and GPS are lost, and manual control loss is set to Return mode and GCS link loss to Land, Land is executed.

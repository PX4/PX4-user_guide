---
canonicalUrl: https://docs.px4.io/main/ja/msg_docs/vehicle_command
---

# vehicle_command (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/vehicle_command.msg)

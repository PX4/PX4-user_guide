...
| <a id="key_automatic"></a>[<img src="../../assets/site/automatic_mode.svg" title="Automatic mode" width="30px" />](#key_automatic)                                                                                                                                                                                                                                     | 自律モード. モードの切替を除いて，RC送信機からの信号は無効化されます。                                    |
...
:::tip
The PX4 GCS is called [QGroundControl](https://docs.qgroundcontrol.com/en/). :::tip The PX4 GCS is called [QGroundControl](https://docs.qgroundcontrol.com/en/).
:::

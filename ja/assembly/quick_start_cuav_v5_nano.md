...
The v5 nano kit includes HV\_PM, which supports 2~10S LiPo battery. Please connect the 6pin connector of the HW\_PM module to the flight control `Power` interface.

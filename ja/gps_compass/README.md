...
| [LOCOSYS Hawk R2](../gps_compass/gps_locosys_hawk_r2.md)                                                                                                                                                                                    | MC-1612-V2b  |     IST8310      |             &cross;              |                                                          |                                                              |         |
...
:::note
The default [Serial Port Configuration](../peripherals/serial_configuration.md#default_port_mapping) works for most devices. :::tip
If using this feature, all other configuration should be setup up as normal (e.g.
:::
...
That said, developers can disable internal compasses if desired using the compass parameters. Then use [CAL\_MAGx\_PRIO](../advanced_config/parameter_reference.md#CAL_MAG0_PRIO) to disable the compass.

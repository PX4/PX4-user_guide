...
- STM32H7: the bootloader is based on NuttX, and is included in the PX4 Firmware. See [here](https://github.com/PX4/PX4-Autopilot/tree/release/1.13/boards/holybro/durandal-v1/nuttx-config/bootloader) for an example.

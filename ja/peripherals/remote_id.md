...
リモートIDは、UAVと他の航空機との安全な空域共有を実現するために、日本、アメリカ合衆国、およびヨーロッパ連合で政府によって義務付けられた技術である。
この仕様により、UAVはリアルタイムの位置情報/高度、シリアル番号、オペレーターID/位置、ステータスなどのデータを無線で送信することが求められている。

...
[ROS](../ros/README.md) (Robot Operating System) can be used with PX4 and the [Gazebo simulator](../sim_gazebo_classic/README.md). 它使用[ MAVROS](../ros/mavros_installation.md) MAVLink 节点与 PX4 通信。

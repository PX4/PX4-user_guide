...
1. 创建一个YAML模块配置文件
   ...
   > **Note** The full documentation of the module configuration file can be found in the [validation/module_schema.yaml](https://github.com/PX4/PX4-Autopilot/blob/master/validation/module_schema.yaml) file. 这也用于验证 CI 中的所有配置文件。

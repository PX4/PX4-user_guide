...
:::warning
The PX4 development team recommend that all users [upgrade to ROS 2](../ros2/index.md). This documentation reflects the "old approach". Kinetic 同样支持 Debian Jessie amd64 和 arm64（ARMv8）。
...
:::tip
These instructions are a simplified version of the [official installation guide](https://github.com/mavlink/mavros/tree/master/mavros#installation). They cover the _ROS Melodic and Noetic_ releases. Kinetic 同样支持 Debian Jessie amd64 和 arm64（ARMv8）。

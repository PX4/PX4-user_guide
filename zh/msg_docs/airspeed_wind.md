---
canonicalUrl: https://docs.px4.io/main/zh/msg_docs/airspeed_wind
---

# airspeed_wind (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/airspeed_wind.msg)

---
canonicalUrl: https://docs.px4.io/main/zh/msg_docs/estimator_gps_status
---

# estimator_gps_status (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/estimator_gps_status.msg)

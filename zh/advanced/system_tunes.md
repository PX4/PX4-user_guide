...
提示音使用特定的字符串([ANSI 音符](http://artscene.textfiles.com/ansimusic/information/ansimtech.txt))，并使用


tunes</0>库代码播放。 乐曲库也包含默认系统调节列表 - 见 [lib/tunes/tune_definition.desc](https://github.com/PX4/PX4-Autopilot/blob/main/src/lib/tunes/tune_definition.desc)。</p> 

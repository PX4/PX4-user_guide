...
* Outside center: 
  ...
  * 偏航杆操纵会驱动方向舵（指令将被加到自动驾驶仪计算的指令中以维持[协调飞行](https://en.wikipedia.org/wiki/Coordinated_flight)）。 This is same as in [Stabilized mode](#stabilized_fw).
...
<td>
  在高度稳定模式下手动控制的最大俯仰角。 Default: 45 degrees.
</td></tr> 
...
<tr>
  <td>
    ...
    <td>
      在高度稳定模式下手动控制的最大滚转角。 Default: 45 degrees.
    </td></tr> 

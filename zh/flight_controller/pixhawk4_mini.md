...
> **Warning** PX4 不生产这款且也不生产任何自动驾驶仪。 若需要硬件支持或咨询合规问题，请联系 [制造商](https://shop.holybro.com/)。 NEVER connect any servos, power supplies or batteries (or to any connected receiver).

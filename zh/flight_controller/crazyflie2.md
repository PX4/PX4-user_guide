...
Crazyflie 是由 Bitcraze AB创建的卫星飞行器。 An overview of the Crazyflie 2.0 can be [found here](https://www.bitcraze.io/crazyflie-2/).

![Crazyflie2 Image](../../assets/flight_controller/crazyflie/crazyflie2_hero.png)

## 总览

> **注意** 主要硬件文档：https://wiki.bitcraze.io/projects:crazyflie2:index

* 主系统上芯片： STM32F405RG 
  * CPU： 168 MHz ARM Cortex M4 具有单精度FPU
  * RAM: 192 KB SRAM
* nRF51822 无线电和电力管理 MCU
...
* [Crazyradio PA 2.4 GHz USB dongle](https://store.bitcraze.io/collections/kits/products/crazyradio-pa): 用于 *QGroundControl* 和 Crazyflie 2.0 之间的无线通信。
* [扩展板](https://store.bitcraze.io/collections/decks/products/breakout-deck): 为连接新的外设的分解扩展板. 

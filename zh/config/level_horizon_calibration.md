...
3. 点击 **Level Horizon** 按钮。 ![Level Horizon calibration](../../assets/qgc/setup/sensor/sensor_level_horizon.jpg) > **Note** 您应该已经设置好 [Autopilot Orientation](../config/flight_controller_orientation.md)。 如果没有，也可以在这里设置。 
4. 将飞行器放置于水平方向： 

...
- [垂直起降](frames_vtol/index.md)
  ...
  - [整机](complete_vehicles_vtol/index.md)
...
- [Hardware Selection & Setup](hardware/drone_parts.md)
  ...
  - [飞行控制器(Autopilots)](flight_controller/index.md)
    - [选择飞控](getting_started/flight_controller_selection.md)
    ...
    - [安装固定飞控](assembly/mount_and_orient_controller.md)
    - [振动隔离](assembly/vibration_isolation.md)
    - [Updating Firmware](config/firmware.md)
    - [飞行控制器/传感器方向](config/flight_controller_orientation.md)
  ...
  - [传感器](sensor/index.md)
    ...
    - [罗盘](gps_compass/magnetometer.md)
...
- [开发](development/development.md)
  ...
  - [中间件](middleware/index.md)
    ...
    - [uORB 消息参考](msg_docs/index.md)
      - [操作请求](msg_docs/ActionRequest.md)

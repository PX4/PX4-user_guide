...
| <a id="key_automatic"></a>[<img src="../../assets/site/automatic_mode.svg" title="Automatic mode" width="30px" />](#key_automatic)                                                                                                                                                                                                                                     | 自动模式. 除非切换模式，否则 RC 控制被默认失能。 Global position estimate required. |

---
canonicalUrl: https://docs.px4.io/main/ru/sensor/rangefinders
---
...
The common rangefinder configuration is specified using [EKF2\_RNG\_*](../advanced_config/parameter_reference.md#EKF2_RNG_AID) parameters. These include (non exhaustively):

---
canonicalUrl: https://docs.px4.io/main/ru/modules/modules_driver_distance_sensor
---

# Modules Reference: Distance Sensor (Driver)
## afbrs50
Source: [drivers/distance_sensor/broadcom/afbrs50](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/broadcom/afbrs50)
...
```
## gy_us42
Source: [drivers/distance_sensor/gy_us42](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/gy_us42)
...
```
## leddar_one
Source: [drivers/distance_sensor/leddar_one](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/leddar_one)
...
```
## lightware_laser_i2c
Source: [drivers/distance_sensor/lightware_laser_i2c](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/lightware_laser_i2c)
...
Source: [drivers/distance_sensor/lightware_laser_serial](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/lightware_laser_serial)
...
```
## ll40ls
Source: [drivers/distance_sensor/ll40ls](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/ll40ls)
...
```
## mappydot
Source: [drivers/distance_sensor/mappydot](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/mappydot)
...
```
## mb12xx
Source: [drivers/distance_sensor/mb12xx](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/mb12xx)
...
```
## pga460
Source: [drivers/distance_sensor/pga460](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/pga460)
...
```
## srf02
Source: [drivers/distance_sensor/srf02](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/srf02)
...
```
## srf05
Source: [drivers/distance_sensor/srf05](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/srf05)
...
```
## teraranger
Source: [drivers/distance_sensor/teraranger](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/teraranger)
...
```
## tfmini
Source: [drivers/distance_sensor/tfmini](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/tfmini)
...
```
## ulanding_radar
Source: [drivers/distance_sensor/ulanding_radar](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/ulanding_radar)
...
```
## vl53l0x
Source: [drivers/distance_sensor/vl53l0x](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/vl53l0x)
...
```
## vl53l1x
Source: [drivers/distance_sensor/vl53l1x](https://github.com/PX4/PX4-Autopilot/tree/release/1.14/src/drivers/distance_sensor/vl53l1x)

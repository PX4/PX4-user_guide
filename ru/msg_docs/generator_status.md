---
canonicalUrl: https://docs.px4.io/main/ru/msg_docs/generator_status
---

# generator_status (UORB message)



[source file](https://github.com/PX4/PX4-Autopilot/blob/release/1.13/msg/generator_status.msg)

...
Gazebo support video streaming from within the simulated environment. For more information see [Gazebo Simulation > Video Streaming](../sim_gazebo_classic/README.md#video-streaming).

...
- You can verify the NuttX installation by confirming the gcc version as shown:
  ...
  ```
- You're going to need the PX4 source code anyway. You're going to need the PX4 source code anyway. <!-- NEED px4_version -->
   ```bash
